  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 p-4 rounded-xl border border-indigo-100 dark:border-indigo-950/40 bg-indigo-50/40 dark:bg-indigo-950/10 text-slate-700 dark:text-slate-300">
          <div className="flex items-center gap-3">
            ...
            <p className="text-xs sm:text-sm">
              ...
              <span className="text-emerald-600 dark:text-emerald-400 font-bold">{formatRupiah(averageSurplus)}</span>.
            </p>
          </div>
          <button
            onClick={() => setShowInfo(!showInfo)}
            className="text-xs font-semibold text-indigo-600 dark:text-indigo-400 hover:text-indigo-500 dark:hover:text-indigo-300 transition cursor-pointer self-start sm:self-auto"
          >
        ...
        {showInfo && (
          <div className="p-5 rounded-xl border border-slate-200 dark:border-[#1e2235] bg-slate-50/50 dark:bg-[#141624]/65 text-xs text-slate-600 dark:text-slate-300 space-y-4 leading-relaxed">
            <div className="space-y-1.5">
              <h4 className="font-bold text-slate-900 dark:text-white text-sm">📐 Rumus Perhitungan Target & Proyeksi:</h4>
              <ul className="list-disc pl-5 space-y-1 text-slate-500 dark:text-slate-400">
                <li>
                  <span className="text-slate-950 dark:text-white font-medium">Sisa Kekurangan</span> = Target Nominal − Dana Terkumpul
                </li>
                <li>
                  <span className="text-slate-950 dark:text-white font-medium">Target Tabungan Bulanan</span> = Sisa Kekurangan ÷ Sisa Bulan s.d. Tanggal Target
                </li>
                <li>
                  <span className="text-slate-950 dark:text-white font-medium">Surplus Bulanan Aktif</span> = Diambil dari pencatatan transaksi di <strong>Arus Kas (Expense Tracker)</strong>. Kami hanya menghitung rata-rata dari bulan yang memiliki aktivitas transaksi agar kalkulasi pengguna baru tidak ter-dilusi oleh bulan kosong di masa lalu.
                </li>
              </ul>
            </div>

            <div className="space-y-1.5 border-t border-slate-200 dark:border-[#1e2235] pt-3">
              <h4 className="font-bold text-slate-900 dark:text-white text-sm">💡 Hubungan dengan Expense Tracker & Aset:</h4>
              ...
              >
                <div className="space-y-3">
                  ...
                  <div className="flex items-center gap-1.5 text-xs text-slate-400">
                    ...
                    {!isCompleted && (
                      <span className="text-[10px] bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 px-1.5 py-0.5 rounded-full font-medium shrink-0">
